  ...
  */
  ...
  class LoadNotification {
    constructor(popup, pswpElement) {
      ...
      this.notificationWrapper = this.pswpElement.querySelector(
        selectors$11.notification
      );
      this.closeBtn = this.pswpElement.querySelector(selectors$11.popupClose);

      // Bind methods to preserve context
      this.handleClose = this.handleClose.bind(this);
      this.notificationSubmitEvent = this.notificationSubmitEvent.bind(this);
    ...
    handleClose() {
      if (this.popup && !this.popup.isDestroyed) {
        ...
        this.pswpElement.classList.remove("pswp--open");
        document.dispatchEvent(
    ...
    init() {
      ...
      this.popup.listen("destroy", () => {
        ...
        this.notificationForm.removeEventListener(
          "submit",
          this.notificationSubmitEvent
        );
  ...
  class LoadPhotoswipe {
    ...
    initPopupCallback() {
      ...
      this.closePopup = () => {
        if (this.pswpElement.classList.contains(classes$D.quickviewPopup)) {
          this.pswpElement.classList.add(classes$D.quickViewAnimateOut);
        }
        if (this.popup && !this.popup.isDestroyed) {
          this.popup.destroy();
        }
  ...
  class CartDrawer {
    ...
    assignArguments() {
      ...
      this.cartItemsQtyBubble = document.querySelector(
        selectors$J.cartItemsQtyBubble
      );
  ...
  class Header {
    ...
    headerState(event) {
      ...
      if (!this.hasScrolled) {
        ...
        if (
          ...
          window.location.pathname === "/fr/pages/faq" ||
          window.location.pathname === "/pages/faq" ||
          window.location.pathname === "/ar/pages/faq"
        ) {
          icons.style.filter = "invert(1)";
          cart.forEach((item) => {
            item.style.filter = "invert(1)";
    ...
    updateBackgroundHeight(event) {
      ...
      if (event.type === "mouseenter" || drawersVisible) {
        ...
        this.header.classList.contains("site-header--transparent")
      ) {
        console.log(cart);
      ...
      if (this.tabButtons.length) {
        this.tabButtons.forEach((tabButton) => {
          tabButton.addEventListener("click", (e) => {
            ...
            const productInstance = this.container.querySelectorAll(
              ".custom-jersey-product"
            );
            if (productInstance) {
